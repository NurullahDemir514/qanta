-- Fix installment deletion for professional system
-- Only refund the remaining debt amount, not the total amount
-- Because only remaining debt was added to credit card balance
