-- Fix historical installment handling
-- When creating installment transactions with past dates, 
-- automatically mark past installments as paid

BEGIN;

-- Update create_installment_transaction to handle historical installments
...
BEGIN
    ...
    -- Create installment details and handle historical payments
    ...
    FOR i IN 1..p_count LOOP
        ...
        -- If this installment is in the past, mark as paid and create transaction
