-- Professional installment system
-- Only create main transaction, no individual installment transactions
-- Installments are just payment schedule, not separate transactions
...
BEGIN
    ...
    FOR i IN 1..p_count LOOP
        ...
        -- (if payment due date has passed)
        IF v_payment_due_date < v_today THEN
            -- Mark as paid and count it
