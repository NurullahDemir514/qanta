...
class DateUtils {
  ...
  static final DateFormat _isoFormat = DateFormat(
  ...
  /// ```
  static DateTime getStatementPeriodStart(
    int statementDay, {
    ...
    if (referenceDate.day < statementDay) {
      ...
      final prevYear = referenceDate.month == 1
  ...
  /// ```
  static DateTime getStatementPeriodEnd(
    int statementDay, {
    DateTime? referenceDate,
  }) {
    final periodStart = getStatementPeriodStart(
      statementDay,
  ...
  /// ```
  static DateTime getStatementDueDate(
    int statementDay, {
    DateTime? referenceDate,
    int? dueDay,
  }) {
    final periodEnd = getStatementPeriodEnd(
      statementDay,
      referenceDate: referenceDate,
    );
  ...
  static DateTime getStatementPeriodForDate(
  ...
  /// - "Mar 2024"
  /// - "Eki 2023"
  static String formatPeriodText(
    ...
    if (context != null) {
      try {
        ...
        final formatter = DateFormat('MMM yyyy', locale.languageCode);
        return formatter.format(periodStart);
      } catch (e) {
        // Fallback to cached formatter
  ...
  /// - "15 Mar 2024"
  /// - "28 Eki 2023"
  static String formatDueDateText(DateTime dueDate, {BuildContext? context}) {
    if (context != null) {
      try {
        final locale = Localizations.localeOf(context);
