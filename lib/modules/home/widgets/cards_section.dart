...
class _CardsSectionState extends State<CardsSection> {
  ...
  Widget _buildV2CardsSection(
    BuildContext context,
    UnifiedProviderV2 providerV2,
    ...
    for (final card in providerV2.creditCards) {
      allCards.add({
        ...
        'balance':
            card['availableLimit']?.toDouble() ??
            0.0, // Use provider's availableLimit directly
    ...
    final sortedCards = _sortCardsByUsage(
      allCards,
  ...
  List<Map<String, dynamic>> _sortCardsByUsage(
    ...
    cards.sort((a, b) {
      ...
      if (usageA == usageB) {
        return _getCardTypePriority(
          a['cardType'] as String,
